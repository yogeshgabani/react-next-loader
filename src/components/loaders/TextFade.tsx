...
/** Text Fade — letters fade in and out in sequence. */
export const TextFade = forwardRef<HTMLSpanElement, BaseLoaderProps>(function TextFade(
      ...
      {chars.map((char, i) => (
        <span
          ...
          style={{
            ...
            animation: `${KEYFRAME.textFade} ${duration} ease-in-out ${i * 0.1}s infinite`,
          }}
        >
          {char === ' ' ? ' ' : char}
        </span>

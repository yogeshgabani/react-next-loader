...
export const TextScale = forwardRef<HTMLSpanElement, BaseLoaderProps>(function TextScale(
  {
    text = 'LOADING',
    size,
    color,
      ...
      {chars.map((char, i) => (
        <span
          ...
          style={{
            ...
            animation: `${KEYFRAME.textScale} ${duration} ease-in-out ${i * 0.1}s infinite`,
          }}
        >
          {char === ' ' ? ' ' : char}
        </span>

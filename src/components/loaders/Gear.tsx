...
// Material "settings" cog outline (with a hole in the centre), URL-encoded for a CSS mask.
const COG =
...
/** Gear — a spinning cog wheel. */
export const Gear = forwardRef<HTMLDivElement, BaseLoaderProps>(function Gear(props, ref) {
